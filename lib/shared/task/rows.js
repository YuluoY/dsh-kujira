...
import { createClampedText, projectPath } from "./text.js";
    ...
    return h(
      ...
      h(
        ...
        h(
          ...
          h(Text, { as: "strong", text: t(title), lines: 2 }),
        ...
        h(
          "span",
          {
            className:
              "kj-task-status" +
              (op.status === "running" ? " kj-visually-hidden" : ""),
          },
      ...
      h(
        ...
        h(
          "span",
          {
            className:
              "kj-task-status" +
              (isActiveStage(child.stage) ? " kj-visually-hidden" : ""),
          },
