...
export function renderSettingsPanel({
  ...
  return h(
    ...
    h(
      ...
      exchangeNote() ? h("p", { className: "kj-caption", role: "status" }, exchangeNote()) : null,
      choice("主题", "theme", [
        ["system", "自动"],
        ["light", "浅色"],
        ["dark", "深色"],
      ...
      disclosure(
        ...
        h(
          ...
          toggle("悬停显示进展", "hoverProgress", "鼠标停留在人物上时显示任务进展；关闭不影响键盘访问和任务状态提醒。"),
      ...
      disclosure(
        ...
        h(
          ...
          h("p", { className: "kj-caption" }, t("按人民币设置，当前约合 {amount}", { amount: money(prefs.budget) })),
        ),
      ),
    ),
    h(
