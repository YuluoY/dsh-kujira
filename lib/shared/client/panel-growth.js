...
export function renderGrowthPanel({
  ...
  return h(
    ...
    h(
              ...
              disclosure(
                ...
                h(
                  ...
                  h(
                    ...
                    inventory?.rules
                      ? t(
                          "每 {amount} 判定一次，掉落概率 {chance}，成功获得 {min}–{max} 件。",
                          {
                            amount: I18N.money(inventory.rules.amount, "CNY"),
                            chance: I18N.number(inventory.rules.chance / 100, {
                              style: "percent",
                            }),
      ...
      animationControls ? disclosure("动作点播", animationControls) : null,
    ),
  );
}
