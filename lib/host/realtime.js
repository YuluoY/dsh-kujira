...
export function createRealtime({ getKey, fetch: request = globalThis.fetch, cacheDir = join(homedir(), '.dsh', 'dsh-kujira'), disabled = false } = {}) {
    let pricing = structuredClone(PRICING), settings = { automatic: true, modelAssist: false, intervalHours: 24, model: 'deepseek-flash' }, checkedAt = 0, attemptedAt = 0, modelAt = 0, summary = '', busy = null;
