...
test('switching wide and ordinary clips preserves native video styles',()=>{
 const f=fixture();
 for(const name of ['被落叶淹没','待机呼吸休闲','放烟花']){
  f.player.play(name);const next=f.frontRef.current===f.a?f.b:f.a;next.emit('canplay');
